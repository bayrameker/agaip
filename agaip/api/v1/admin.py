...
from agaip.api.dependencies import require_admin, get_container_dependency
...
@router.get("/admin/system/status", response_model=SystemStatusResponse, summary="Get system status")
...
async def restart_agent(
    ...
    if not success:
        raise HTTPException(status_code=404, detail="Agent not found or cannot be restarted")
